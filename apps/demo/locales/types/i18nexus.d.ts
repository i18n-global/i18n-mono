...
declare type DocsI18nexusProviderKeys =
...
declare type DocsI18nexusServerComponentsKeys =
  | "'use client' 필요"
...
declare type DocsI18nexusToolsKeys =
  | '// locales/en.json\n{\n  "환영합니다": "Welcome",\n  "시작하기": "Get Started"\n}'
...
declare type DocsI18nexusToolsDownloadKeys =
...
declare type DocsI18nexusToolsDownloadForceKeys =
  | "CI/CD에서 사용"
...
declare type DocsI18nexusToolsExtractorKeys =
  | '// 이런 코드를 찾습니다:\nt("환영합니다")\nt("시작하기")\nt(\\`안녕하세요 \\${name}님\\`)'
  | '// 추출된 키:\n"환영합니다"\n"시작하기"\n"안녕하세요 \\${name}님"'
  | "CI/CD에 통합하기"
  ...
  | "키 추출"
  | "특정 언어 파일 생성"
  | "팀 협업을 위한 Google Sheets 연동 설정하기"
  | "파일 저장"
  | "파일을 수정하지 않고 추출될 키와 통계만 확인합니다."
  | "플래그"
  | "한국어 텍스트를 자동으로 래핑하는 방법 알아보기"
  | "홈";

declare type DocsI18nexusToolsGoogleSheetsKeys =
  ...
  | "Sheets에 있는 키: 값을 업데이트"
  | "Sheets에서 로컬로"
  | "Sheets의 번역으로 업데이트하되, 로컬에만 있는 번역은 보존"
...
declare type DocsI18nexusToolsUploadKeys =
  | "Google Cloud 서비스 계정 인증 정보 JSON 파일 경로 (필수)"
  | "Google Sheets 초기 설정 가이드 보기"
  | "Google Sheets의 Spreadsheet ID (필수)"
...
declare type DocsI18nexusToolsWrapperKeys =
...
declare type DocsI18nexusUseLanguageSwitcherKeys =
...
declare type DocsI18nexusUseTranslationKeys =
...
declare type GettingStartedKeys =
  ...
  | "root layout.tsx에 추가하세요"
  | '{\n  "안녕하세요": "Hello",\n  "환영합니다": "Welcome"\n}'
  | '{\n  "안녕하세요": "안녕하세요",\n  "환영합니다": "환영합니다"\n}'
  | "결과 파일"
  | "다음을 생성합니다"
  | "모든 한국어 텍스트를 자동으로 t()로 감쌉니다"
  | "번역 다운로드"
  | "번역 업로드"
  | "번역 키 추출"
  | "번역 파일"
  | "번역 파일 디렉토리 (ko.json, en.json)"
  | "서버 컴포넌트"
  | "서버 컴포넌트의 경우"
...
declare type ServerExampleKeys =
  | "'use client' 필요"
  | "getServerTranslation() 사용"
...
/** Translation keys for "showcase" namespace */
declare type ShowcaseKeys =
  | "i18nexus 쇼케이스"
  | "i18nexus와 i18nexus-tools를 사용하는 실제 프로젝트들"
  | "내 프로젝트 등록하기"
  | "아직 등록된 프로젝트가 없습니다"
...
declare type TranslationKeys = {
  ...
  "docs-i18nexus-tools": DocsI18nexusToolsKeys;
  "docs-i18nexus-tools-download": DocsI18nexusToolsDownloadKeys;
  "docs-i18nexus-tools-download-force": DocsI18nexusToolsDownloadForceKeys;
  "docs-i18nexus-tools-extractor": DocsI18nexusToolsExtractorKeys;
  "docs-i18nexus-tools-google-sheets": DocsI18nexusToolsGoogleSheetsKeys;
  "docs-i18nexus-tools-upload": DocsI18nexusToolsUploadKeys;
...
declare module "i18nexus" {
  ...
  export type DocsI18nexusServerComponentsKeys =
    TranslationKeys["docs-i18nexus-server-components"];
  export type DocsI18nexusToolsKeys = TranslationKeys["docs-i18nexus-tools"];
  export type DocsI18nexusToolsDownloadKeys =
    TranslationKeys["docs-i18nexus-tools-download"];
  export type DocsI18nexusToolsDownloadForceKeys =
    TranslationKeys["docs-i18nexus-tools-download-force"];
  export type DocsI18nexusToolsExtractorKeys =
    TranslationKeys["docs-i18nexus-tools-extractor"];
  export type DocsI18nexusToolsGoogleSheetsKeys =
    TranslationKeys["docs-i18nexus-tools-google-sheets"];
  export type DocsI18nexusToolsUploadKeys =
    TranslationKeys["docs-i18nexus-tools-upload"];
  export type DocsI18nexusToolsWrapperKeys =
    TranslationKeys["docs-i18nexus-tools-wrapper"];
  export type DocsI18nexusUseLanguageSwitcherKeys =
