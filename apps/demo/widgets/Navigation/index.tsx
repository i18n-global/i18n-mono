        ...
        <div className="flex flex-col h-full w-64">
          ...
          <div className="flex items-center justify-between p-4 border-b border-slate-800">
            <Link
              ...
              <span className="text-lg font-bold text-blue-400">i18nexus</span>
            </Link>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button
                ...
                title={String(sidebarOpen ? t("닫기") : t("메뉴 열기"))}>
                <svg
              ...
              <Link
                ...
                <Image
                  ...
                  width={54}
                  height={40}
                  className="rounded-lg sm:rounded-xl shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-all group-hover:scale-110 object-contain" />
